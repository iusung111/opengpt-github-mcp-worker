/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/types/worker-configuration.d.ts` (hash: 3a5939b03114e4da4e63d8f5541b760a)
...
declare namespace Cloudflare {
	...
	interface MirrorEnv {
		...
		GITHUB_ALLOWED_WORKFLOWS_BY_REPO: "{\"iusung111/OpenGPT\":[\"agent-run.yml\",\"pr-merge.yml\",\"cloudflare-live-deploy.yml\"],\"iusung111/opengpt-github-mcp-worker\":[\"cloudflare-self-deploy.yml\",\"gui-capture.yml\"],\"iusung111/opengpt-github-mcp-worker-mirror-backup\":[\"cloudflare-self-deploy.yml\",\"gui-capture.yml\"]}";
