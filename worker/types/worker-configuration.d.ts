/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/types/worker-configuration.d.ts` (hash: 40a3760250adb6e6dbdce9f1bce6a9dc)
// Runtime types generated with workerd@1.20260317.1 2026-03-10 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../src/index");
		durableNamespaces: "JobQueueDurableObject" | "UploadSessionDurableObject";
	}
	interface MirrorEnv {
		GITHUB_API_URL: "https://api.github.com";
		GITHUB_ALLOWED_REPOS: "iusung111/Project_OpenGPT,iusung111/opengpt-github-mcp-worker,iusung111/opengpt-github-mcp-worker-mirror-backup";
		GITHUB_ALLOWED_WORKFLOWS: "agent-run.yml,pr-merge.yml,cloudflare-live-deploy.yml,cloudflare-self-deploy.yml";
		GITHUB_ALLOWED_WORKFLOWS_BY_REPO: "{\"iusung111/Project_OpenGPT\":[\"agent-run.yml\",\"pr-merge.yml\",\"cloudflare-live-deploy.yml\",\"opengpt-exec.yml\",\"opengpt-package.yml\"],\"iusung111/opengpt-github-mcp-worker\":[\"cloudflare-self-deploy.yml\",\"gui-capture.yml\",\"opengpt-exec.yml\",\"opengpt-package.yml\"],\"iusung111/opengpt-github-mcp-worker-mirror-backup\":[\"cloudflare-self-deploy.yml\",\"gui-capture.yml\",\"opengpt-exec.yml\",\"opengpt-package.yml\"]}";
		AGENT_BRANCH_PREFIX: "agent/";
		DEFAULT_BASE_BRANCH: "main";
		SELF_REPO_KEY: "iusung111/opengpt-github-mcp-worker";
		SELF_DEPLOY_WORKFLOW: "cloudflare-self-deploy.yml";
		SELF_LIVE_URL: "https://opengpt-github-mcp-worker.iusung111.workers.dev";
		SELF_MIRROR_URL: "https://opengpt-github-mcp-worker-mirror.iusung111.workers.dev";
		SELF_CURRENT_URL: "https://opengpt-github-mcp-worker-mirror.iusung111.workers.dev";
		SELF_DEFAULT_DEPLOY_TARGET: "mirror";
		SELF_REQUIRE_MIRROR_FOR_LIVE: "true";
		...
		GUI_OIDC_CLIENT_ID: "ZVOPZ3w5zfRTw0brgJdlDLKQ5jxrNpAm";
		DEFAULT_AUTO_IMPROVE_MAX_CYCLES: "1";
		WORKING_STALE_AFTER_MS: "600000";
		REVIEW_STALE_AFTER_MS: "1800000";
		DISPATCH_DEDUPE_WINDOW_MS: "30000";
		AUDIT_RETENTION_COUNT: "500";
		DELIVERY_RETENTION_COUNT: "500";
		...
		FILE_UPLOADS: DurableObjectNamespace<import("../src/index").UploadSessionDurableObject>;
	}
	interface Env {
		GITHUB_API_URL: "https://api.github.com";
		GITHUB_ALLOWED_REPOS: "iusung111/Project_OpenGPT,iusung111/opengpt-github-mcp-worker,iusung111/opengpt-github-mcp-worker-mirror-backup";
		...
		SELF_LIVE_URL: "https://opengpt-github-mcp-worker.iusung111.workers.dev";
		SELF_MIRROR_URL: "https://opengpt-github-mcp-worker-mirror.iusung111.workers.dev";
		SELF_CURRENT_URL: "https://opengpt-github-mcp-worker-mirror.iusung111.workers.dev" | "https://opengpt-github-mcp-worker.iusung111.workers.dev";
		SELF_DEFAULT_DEPLOY_TARGET: "mirror";
		SELF_REQUIRE_MIRROR_FOR_LIVE: "true";
		MCP_REQUIRE_ACCESS_AUTH: "false";
		MCP_ALLOWED_EMAILS: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_API_URL" | "GITHUB_ALLOWED_REPOS" | "GITHUB_ALLOWED_WORKFLOWS" | "GITHUB_ALLOWED_WORKFLOWS_BY_REPO" | "AGENT_BRANCH_PREFIX" | "DEFAULT_BASE_BRANCH" | "SELF_REPO_KEY" | "SELF_DEPLOY_WORKFLOW" | "SELF_LIVE_URL" | "SELF_MIRROR_URL" | "SELF_CURRENT_URL" | "SELF_DEFAULT_DEPLOY_TARGET" | "SELF_REQUIRE_MIRROR_FOR_LIVE" | "MCP_REQUIRE_ACCESS_AUTH" | "MCP_ALLOWED_EMAILS" | "MCP_ALLOWED_EMAIL_DOMAINS" | "CHATGPT_MCP_AUTH_MODE" | "CHATGPT_MCP_ISSUER" | "CHATGPT_MCP_AUDIENCE" | "CHATGPT_MCP_JWKS_URL" | "CHATGPT_MCP_JWKS_JSON" | "CHATGPT_MCP_ALLOWED_EMAILS" | "GUI_OIDC_CLIENT_ID" | "DEFAULT_AUTO_IMPROVE_MAX_CYCLES" | "WORKING_STALE_AFTER_MS" | "REVIEW_STALE_AFTER_MS" | "DISPATCH_DEDUPE_WINDOW_MS" | "AUDIT_RETENTION_COUNT" | "DELIVERY_RETENTION_COUNT" | "REQUIRE_WEBHOOK_SECRET" | "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID">> {}
}
