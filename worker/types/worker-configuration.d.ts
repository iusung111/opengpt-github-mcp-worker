/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/types/worker-configuration.d.ts` (hash: b26779524c87af2df48affd8a70e53e3)
...
declare namespace Cloudflare {
	...
	interface MirrorEnv {
		...
		GITHUB_ALLOWED_WORKFLOWS: "agent-run.yml,pr-validate.yml,pr-merge.yml,cloudflare-live-deploy.yml,cloudflare-self-deploy.yml";
