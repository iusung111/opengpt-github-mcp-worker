/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/types/worker-configuration.d.ts` (hash: 8ffb740ec58dcd9b5921069f172a3ca5)
...
declare namespace Cloudflare {
	...
	interface MirrorEnv {
		...
		GITHUB_ALLOWED_REPOS: "iusung111/OpenGPT,iusung111/opengpt-github-mcp-worker";
		GITHUB_ALLOWED_WORKFLOWS: "agent-run.yml,pr-merge.yml,cloudflare-live-deploy.yml,cloudflare-self-deploy.yml";
		GITHUB_ALLOWED_WORKFLOWS_BY_REPO: "{\"iusung111/OpenGPT\":[\"agent-run.yml\",\"pr-merge.yml\",\"cloudflare-live-deploy.yml\"],\"iusung111/opengpt-github-mcp-worker\":[\"cloudflare-self-deploy.yml\",\"gui-capture.yml\"]}";
